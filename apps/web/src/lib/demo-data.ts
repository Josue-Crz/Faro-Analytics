...
export const dashboardMetrics = [
  {
    ...
    change: 'Queue reset',
    direction: 'up',
    detail: 'All next actions are future-dated',
  },
  {
    label: 'Due next',
    value: '5',
...
export const pipeline = [
  ...
  { stage: 'Committed', count: 5, value: 44000, percent: 21 },
];
...
export const contacts: ContactRecord[] = [
  {
    ...
    nextActionAt: '2026-08-03T15:30:00.000Z',
  ...
  },
  {
    ...
    nextActionAt: '2026-08-04T07:30:00.000Z',
    nextActionType: 'FOLLOW_UP',
    responseRate: 54,
    consent: 'Granted',
  },
  {
    ...
    nextActionAt: '2026-08-03T16:15:00.000Z',
    nextActionType: 'FOLLOW_UP',
    responseRate: 73,
    consent: 'Granted',
  },
  {
    ...
    nextActionAt: '2026-08-03T15:00:00.000Z',
  ...
  },
  {
    ...
    nextActionAt: '2026-08-05T16:00:00.000Z',
    nextActionType: 'FOLLOW_UP',
    responseRate: 29,
    consent: 'Granted',
  },
  {
    ...
    nextActionAt: '2026-08-06T16:00:00.000Z',
    nextActionType: 'FOLLOW_UP',
    responseRate: 81,
    consent: 'Granted',
  },
...
export const followUps: FollowUpRecord[] = [
  {
    ...
    initialAt: '2026-07-09T15:18:00.000Z',
    followUpAt: '2026-08-03T15:30:00.000Z',
    due: 'Aug 3, 10:30 AM CDT',
    dueGroup: 'Upcoming',
    priority: 'High',
    status: 'ready',
    statusLabel: 'Draft ready',
    channel: 'Email',
    recommendedAt: '2026-08-03T15:30:00.000Z',
    recommendedWindow: 'Aug 3, 10:30–11:15 AM CDT',
    confidence: 86,
    sufficiency: 'High',
  ...
  },
  {
    ...
    initialAt: '2026-07-07T23:02:00.000Z',
    followUpAt: '2026-08-03T16:15:00.000Z',
    due: 'Aug 3, 9:15 AM PDT',
    dueGroup: 'Upcoming',
    priority: 'High',
    status: 'attention',
    statusLabel: 'Follow-up scheduled',
    channel: 'Email',
    recommendedAt: '2026-08-03T16:15:00.000Z',
    recommendedWindow: 'Aug 3, 9:15–10:00 AM PDT',
    confidence: 78,
    sufficiency: 'Medium',
  ...
  },
  {
    ...
    initialAt: '2026-07-08T13:42:00.000Z',
    followUpAt: '2026-08-04T07:30:00.000Z',
    due: 'Aug 4, 9:30 AM CEST',
    dueGroup: 'Upcoming',
    priority: 'Medium',
    status: 'awaiting',
    statusLabel: 'Awaiting IBM Bob',
    channel: 'Email',
    recommendedAt: '2026-08-04T07:30:00.000Z',
    recommendedWindow: 'Aug 4, 9:30–10:15 AM CEST',
    confidence: 64,
    sufficiency: 'Medium',
  ...
  },
  {
    ...
    initialAt: '2026-07-03T17:30:00.000Z',
    followUpAt: '2026-08-04T15:00:00.000Z',
    due: 'Aug 4, 11:00 AM EDT',
    dueGroup: 'Upcoming',
    priority: 'Medium',
    status: 'attention',
    statusLabel: 'Needs attention',
    channel: 'Email',
    recommendedAt: '2026-08-04T15:00:00.000Z',
    recommendedWindow: 'Aug 4, 11:00–11:45 AM EDT',
    confidence: 52,
    sufficiency: 'Sparse',
  ...
  },
  {
    ...
    initialAt: '2026-07-10T15:44:00.000Z',
    followUpAt: '2026-08-03T19:00:00.000Z',
    due: 'Aug 3, 12:00 PM PDT',
    dueGroup: 'Upcoming',
    priority: 'High',
    status: 'attention',
    statusLabel: 'Follow-up scheduled',
    channel: 'Email',
    recommendedAt: '2026-08-03T19:00:00.000Z',
    recommendedWindow: 'Aug 3, 12:00 PM PDT',
    confidence: 91,
    sufficiency: 'High',
  ...
  },
  {
    ...
    initialAt: '2026-07-10T16:04:00.000Z',
    followUpAt: '2026-07-10T16:32:00.000Z',
...
export const organizations = [
  {
    ...
    weighted: '$1,000',
    contacts: 0,
    interest: 'Confirmed cash sponsor for the upcoming event',
  ...
  },
  {
    ...
    stage: 'Committed',
    value: '$0 cash',
    weighted: '≈8,000 credits',
    contacts: 0,
    interest: 'In-kind support; no monetary sponsorship',
  ...
  },
  {
    ...
    stage: 'Engaged',
    value: '$0',
    weighted: '$0 confirmed',
    contacts: 0,
    interest: 'High interest in the upcoming and previous events',
    signal: 'Reconnect December',
  },
  {
    id: 'org_solace',
  ...
  {
    id: 'org_alloy_learning',
    name: 'Alloy Learning Systems',
    type: 'Partner',
    industry: 'Technology',
    stage: 'Engaged',
    value: '$34,000',
    weighted: '$18,700',
    contacts: 2,
    interest: 'Student access',
    signal: 'Awaiting response',
  },
  {
    id: 'org_harbor_pantry',
    name: 'Harbor Pantry Collective',
    type: 'Donor',
    industry: 'Food',
    stage: 'Qualified',
    value: '$18,000',
...
export const recentActivity = [
  {
    time: '16:00',
    title: '2027 sponsor timing recommended',
    detail: 'Meta · Start talks in early November before the December loop-back',
    kind: 'recommendation',
  },
  {
    time: '15:58',
    title: 'In-kind sponsorship confirmed',
    detail: 'Tavily · Approximately 8,000 credits · $0 cash',
    kind: 'response',
  },
  {
    time: '15:55',
    title: 'Cash sponsorship confirmed',
    detail: 'jolli.ai · $1,000',
    kind: 'response',
  },
  {
    time: '10:18',
