  ...
  const filtered = useMemo(
    () =>
      contacts.filter((contact) => {
        const matchesQuery = `${contact.name} ${contact.organization} ${contact.email}`
          .toLowerCase()
        ...
        <div className="filters-bar">
          <div className="filters-bar__group">
            ...
            <label>
              ...
              <select className="filter-select" defaultValue="All campaigns">
            ...
            <label>
              ...
              <select className="filter-select" defaultValue="All sources">
          ...
          <div className="panel panel--flush table-wrap">
            <table className="faro-table">
              <caption className="visually-hidden">
                Contacts with type, campaign, stage, latest interaction, response rate, and consent
                status
              </caption>
              <thead>
                <tr>
