...
export const demoWorkspace: DemoWorkspaceData = {
  ...
  dashboard: {
    ...
    metrics: [
      ...
      },
      {
        ...
        unit: 'CURRENCY',
        change: 66000,
        changeLabel: 'new pipeline value, excluding in-kind credits',
        trend: 'UP',
        status: 'ON_TRACK',
    ...
    pipeline: [
      ...
      { stage: 'Engaged', order: 4, organizationCount: 1, value: 0, weightedValue: 0 },
      ...
      { stage: 'Committed', order: 7, organizationCount: 3, value: 61000, weightedValue: 61000 },
  ...
  organizations: [
    ...
    },
    {
      ...
      estimatedValue: 1000,
      weightedValue: 1000,
      interestAreas: ['Confirmed cash sponsor for the upcoming event'],
      tags: ['User-provided update', 'Cash confirmed'],
      decisionMakerContactIds: [],
      contactCount: 0,
      lastActivityAt: '2026-07-30T16:00:00.000Z',
    },
    {
      id: 'org-faro-tavily',
      workspaceId: 'ws-beacon-lab',
      ...
      estimatedValue: 0,
      weightedValue: 0,
      interestAreas: ['Approximately 8,000 credits confirmed', 'No monetary sponsorship'],
      tags: ['User-provided update', 'In-kind confirmed'],
      decisionMakerContactIds: [],
      contactCount: 0,
      lastActivityAt: '2026-07-30T16:00:00.000Z',
    },
    {
      ...
      tags: ['High interest', 'Reconnect in December', 'Start talks in early November'],
      decisionMakerContactIds: [],
      contactCount: 0,
      lastActivityAt: '2026-07-30T16:00:00.000Z',
    },
  ...
  contacts: [
    ...
    },
    {
      ...
      nextActionAt: '2026-08-04T16:00:00.000Z',
      nextActionType: 'FOLLOW_UP',
    },
    {
      ...
      nextActionAt: '2026-08-03T17:00:00.000Z',
      nextActionType: 'FOLLOW_UP',
    },
    {
      ...
      nextActionAt: '2026-08-04T13:30:00.000Z',
      nextActionType: 'FOLLOW_UP',
    },
    {
      id: 'contact-jon-bell',
      ...
      nextActionAt: '2026-08-05T15:30:00.000Z',
      nextActionType: 'FOLLOW_UP',
    },
    {
    ...
    },
    {
      ...
      nextActionAt: '2026-08-07T17:30:00.000Z',
      nextActionType: 'FOLLOW_UP',
    },
  ],
  campaigns: [
  ...
  followUps: [
    {
      ...
      status: 'OPEN',
      priority: 'URGENT',
      initialAt: '2026-07-09T15:52:00.000Z',
    ...
    },
    {
      ...
      status: 'OPEN',
      priority: 'HIGH',
      initialAt: '2026-07-10T14:18:00.000Z',
    ...
    },
    {
      ...
      status: 'OPEN',
      priority: 'HIGH',
      initialAt: '2026-07-07T16:00:00.000Z',
    ...
    },
    {
      ...
      status: 'OPEN',
      priority: 'MEDIUM',
      initialAt: '2026-07-07T15:30:00.000Z',
    ...
    },
    {
      ...
      status: 'SNOOZED',
      priority: 'MEDIUM',
      initialAt: '2026-07-09T17:00:00.000Z',
    ...
    },
    {
      ...
      status: 'COMPLETED',
      priority: 'LOW',
      initialAt: '2026-07-07T14:04:00.000Z',
