...
async function seed(): Promise<void> {
  ...
  const organizations = [
    ...
    },
    {
      ...
      industry: 'Technology',
      estimatedValue: 1000,
      interestAreas: ['Upcoming event sponsorship'],
      tags: ['User-provided update', 'Cash confirmed'],
      customFields: {
      ...
      externalId: 'USER-PROVIDED-SPONSOR-JOLLI-2026',
    },
    {
      id: 'org-faro-tavily',
      sponsorshipStageId: 'stage-committed',
      ...
      industry: 'Technology',
      estimatedValue: 0,
      interestAreas: ['In-kind event credits'],
      tags: ['User-provided update', 'In-kind confirmed', 'No monetary sponsorship'],
      customFields: {
        dataProvenance: 'USER_PROVIDED',
        sponsorshipRelationship: {
          cashAmountUsd: 0,
      ...
      externalId: 'USER-PROVIDED-SPONSOR-TAVILY-2026',
    },
    {
      id: 'org-faro-meta',
      sponsorshipStageId: 'stage-engaged',
      name: 'Meta',
      type: OrganizationType.SPONSOR,
      industry: 'Technology',
      estimatedValue: 0,
      interestAreas: ['Upcoming event', 'Previous events', '2027 sponsorship'],
      tags: ['User-provided update', 'High interest', 'Reconnect in December'],
      customFields: {
        dataProvenance: 'USER_PROVIDED',
        sponsorshipRelationship: {
          cashAmountUsd: 0,
      ...
      externalId: 'USER-PROVIDED-SPONSOR-META-2027',
    },
  ...
  const contacts = [
    {
      ...
      nextActionAt: dt('2026-08-03T16:30:00.000Z'),
      nextActionType: ContactNextActionType.FOLLOW_UP,
    },
    {
      ...
      nextActionAt: dt('2026-08-04T16:00:00.000Z'),
      nextActionType: ContactNextActionType.FOLLOW_UP,
    },
    {
      ...
      nextActionAt: dt('2026-08-03T17:00:00.000Z'),
      nextActionType: ContactNextActionType.FOLLOW_UP,
    },
    {
      ...
      nextActionAt: dt('2026-08-04T13:30:00.000Z'),
      nextActionType: ContactNextActionType.FOLLOW_UP,
    },
    {
      id: 'contact-jon-bell',
      ...
      nextActionAt: dt('2026-08-05T15:30:00.000Z'),
      nextActionType: ContactNextActionType.FOLLOW_UP,
    },
    {
      ...
      nextActionAt: dt('2026-08-06T15:00:00.000Z'),
      nextActionType: ContactNextActionType.FOLLOW_UP,
    },
    {
      ...
      nextActionAt: dt('2026-08-03T17:00:00.000Z'),
      nextActionType: ContactNextActionType.CONSENT_REVIEW,
    },
    {
      ...
      nextActionAt: dt('2026-08-07T17:30:00.000Z'),
      nextActionType: ContactNextActionType.FOLLOW_UP,
    },
    {
      id: 'ct_maya_chen',
      ...
      nextActionAt: dt('2026-08-03T18:00:00.000Z'),
      nextActionType: ContactNextActionType.FOLLOW_UP,
    },
  ...
  const followUps = [
    {
      ...
      initialAt: dt('2026-07-09T15:52:00.000Z'),
    ...
    },
    {
      ...
      initialAt: dt('2026-07-10T14:18:00.000Z'),
    ...
    },
    {
      ...
      status: FollowUpStatus.OPEN,
      priority: Priority.HIGH,
      initialAt: dt('2026-07-07T16:00:00.000Z'),
    ...
    },
    {
      ...
      initialAt: dt('2026-07-07T15:30:00.000Z'),
    ...
    },
    {
      ...
      priority: Priority.MEDIUM,
      initialAt: dt('2026-07-09T17:00:00.000Z'),
    ...
    },
    {
      ...
      initialAt: dt('2026-07-07T14:04:00.000Z'),
    ...
    },
    {
      ...
      status: FollowUpStatus.OPEN,
      priority: Priority.HIGH,
      initialAt: dt('2026-07-07T23:02:00.000Z'),
      dueAt: dt('2026-07-10T16:15:00.000Z'),
  ...
  await prisma.campaign.updateMany({
    data: { sheetConnectionId: sheetConnection.id },
    where: { sheetConnectionId: null, workspaceId },
  });
